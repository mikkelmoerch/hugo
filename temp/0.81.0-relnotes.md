...
Hugo already support adding attribute lists (e.g CSS classes) after titles. We now allow adding attribute lists after Markdown blocks, e.g. tables, lists, paragraphs etc.:
